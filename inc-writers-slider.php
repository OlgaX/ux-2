...
<!--WRITERS-SLIDER-->
<section class="writers-slider">
	<div class="section-title">
		<div class="container">Our writers</div>
	</div>
	<div class="container">
		<div id="writers_slider" class="writers-slider__container">
			<ul class="writers-slider__items-wrap">
			<?php foreach ($writers as $k => $item) : ?>
				<li data-rotateslider="slide" class="writers-slider__slide writers-slider__slide-<?php echo ++$k; ?>">
					<div  class="writers-slider__avatar" >
						<img src="<?php bloginfo('template_url'); ?>/img/writers/<?php echo $item[avatar]; ?>">
					</div>
					<div class="writers-slider__data-list">
						<div class="writers-slider__data">
							<span class="writers-slider__label">Rating:</span>
							<span class="writers-slider__rating">
								<?php for ($i = 0; $i < 5; $i++) : ?>
						...
						<div class="writers-slider__data">
							<span class="writers-slider__label">Completed orders:</span>
							<span class="writers-slider__value"><?php echo $item[orders]; ?></span>
						</div>
						<div class="writers-slider__data">
							<span class="writers-slider__label">Writing experience:</span>
							<span class="writers-slider__value"><?php echo $item[experience]; ?></span>
						</div>
						<div class="writers-slider__data">
							<span class="writers-slider__label">Areas of work:</span>
							<span class="writers-slider__value"><?php echo $item[specialization]; ?></span>
						</div>
					</div>
					<div class="writers-slider__text"><?php echo $item[text]; ?></div>
				</li>
			<?php endforeach; ?>
			</ul>
