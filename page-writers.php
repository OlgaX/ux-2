...
<section class="top-block">
	<div class="container">
		<div class="top-block__title">About Us</div>
	...
	<div class="container">
		<div class="text-wrap">
			...
			<ul class="circle-list">
				<li>Interview and assessment of its adequacy.</li>
				<li>Passing grammatical test (allowed only one mistake)</li>
				<li>Essay writing test (based on the core subject)</li>
				<li>Verification of higher education diplomas</li>
				<li>Coaching the writer about the basic work processes</li>
			</ul>
			<p>
