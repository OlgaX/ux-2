...
<section class="service-desc">
	...
	<div class="container service-desc__wrap">
		<div class="row equal-cols">
			<div class="col-md-6">
				<!--BASIC SERVICES-->
				<div class="service-desc__block service-desc__basic">
					<div class="service-desc__title">Basic Services</div>
					<div class="service-desc__list">
						<ul class="check-list">
					...
					<div class="service-desc__basic-price-block">
						<div class="service-desc__basic-text">Price for 1 page from</div>
						<div class="service-desc__basic-price">$10</div>
					</div>
				</div>
			</div>
			<div class="col-md-6">
				<!--ADDITIONAL SERVICES-->
				<div class="service-desc__block service-desc__additional">
					<div class="service-desc__title">Additional Services</div>
					<div class="service-desc__list">
						<ul class="check-list">
					...
					<div class="service-desc__additional-info">
