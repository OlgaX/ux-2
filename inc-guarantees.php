...
<section class="guarantees">
	...
	<div class="container">
		<div class="guarantees__top-block">
			<div class="row valign">
				<div class="col-sm-6">
					<div class="guarantees__top-img">
						<img src="<?php bloginfo('template_url'); ?>/img/guarantees.jpg" alt="<?php the_title(); ?>" />
					</div>
				</div>
				<div class="col-sm-6">
					<div class="guarantees__top-text">
		...
		<div class="guarantees__items-wrap">
			<?php
				...
				<?php if ($new_row) : ?><div class="row"><?php endif;?>
					...
					<?php if ($k === 1) : ?>
						<div class="col-sm-6">
							<div class="guarantees__block-title"><?php echo $item[block_title]; ?></div>
						</div>
					<?php else : ?>

					<div class="col-sm-6">
						<div class="guarantees__item">
							<div class="guarantees__icon"><i class="<?php echo $item[icon]; ?>"></i></div>
							<div class="guarantees__desc">
								<div class="guarantees__title"><?php echo $item[title]; ?></div>
								<div class="guarantees__text"><?php echo $item[text]; ?></div>
							</div>
						</div>
					</div>
